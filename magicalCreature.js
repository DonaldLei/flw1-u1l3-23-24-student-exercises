...
let creatureDescription = "horselike creature that have a single horn on its head";
...
let zooSummary = "The " + creatureName + " is a " + creatureDescription + "." + " It is " + isFriendly + " that it is friendly to humans." + " The visitor is " + visitorAge + "." + " It is " + canVisit + " that the visitor can see the " + creatureName + ".";
